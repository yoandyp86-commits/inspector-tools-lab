    ...
    if (prevState.activeSearchAspect !== activeSearchAspect) {
      switch (activeSearchAspect) {
        ...
        case this.SearchAspectTypes.org:
          this.ensureKnownBrowserContext();
          break;
        case this.SearchAspectTypes.tools:
          this.ensureKnownBrowserContext();
          break;
      }
    }
      ...
      h(
        ...
        h(
          "li",
          {
            ref: "toolsTab",
            onClick: this.onAspectClick,
            "data-aspect": this.SearchAspectTypes.tools,
            className:
              activeSearchAspect == this.SearchAspectTypes.tools
                ? "slds-tabs_scoped__item slds-is-active"
                : "slds-tabs_scoped__item",
          },
          h(
...
class AllDataBoxTools extends React.PureComponent {
  render() {
    ...
    return h(
      ...
      h(
        "p",
        {className: "slds-text-title_caps slds-p-vertical_x-small slds-p-left_xx-small"},
        "Tools"
      ),
      tools.map((tool) =>
        h(
    ...
    return h(
      ...
      h(
        ...
        h(
          "a",
          {
            href: "permission-sets.html?host=" + this.props.sfHost + "&user=" + user.Id,
            target: "_blank",
            rel: "noopener",
            className: "slds-button slds-button_neutral",
            title: "View this user's assigned permission sets in a new tab",
          },
          "PS"
        ),
